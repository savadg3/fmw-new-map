...
//       // Offset the center point by the random distance
//       const point = [center[0] + dx / 111320, center[1] + dy / 110574]; // approx. conversion for lat/lng
//       points.push(point);
//     }
...
//   function generateRandomBuilding(center, radius) {
//     const points = generateRandomPoints(center, radius, 4); // 4 points for a square-like building
//     points.push(points[0]); // Close the polygon by repeating the first point

//     return {
//       id: `building-${Date.now()}-${Math.random()}`, // Unique ID for the building
//       height: Math.floor(Math.random() * 50) + 5, // Random height between 5 and 55 meters
//       polygon: points
//     };
//   }
...
//         // Generate 50 random buildings
//         const numBuildings = 50;
//         const buildingRadius = 0.001; // Buildings within ~100 meters radius

//         const buildingsData = [];

//         for (let i = 0; i < numBuildings; i++) {
//           buildingsData.push(generateRandomBuilding(center, buildingRadius));
//         }
